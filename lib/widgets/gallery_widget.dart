            ...
            Row(
              ...
              children: [
                ...
                SizedBox(
                  height: 150,
                    // width: 100,
                    child: CachedImage(imageUrl: widget.ProductImageList[widget.selectedItem].imageUrl)),
                // SizedBox(width: 60),
                Row(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        '۴.۶',
                        style: theme.textTheme.headline1?.apply(fontSizeDelta: 1),
                      ),
                    ),
                    // SizedBox(width: 5),
                    CustomIcon(
                    ...
                    return Material(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(child: CachedImage(imageUrl: widget.ProductImageList[index].imageUrl,radius: 10,))
                        ),
                      ),
                    );
                  },
